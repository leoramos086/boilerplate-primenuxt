...
<template>
  <div>
    <div
      class="top-0 left-0 z-[50] fixed flex flex-col bg-contentBg shadow-card rounded-r-card w-64 h-full text-contentCl transform transition-all lg:translate-x-0 duration-300 overflow-hidden ease-out"
      :class="sidebarClass"
